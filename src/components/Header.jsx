  ...
  return (
    <div className='shadow-sm border-b sticky top-0 bg-white z-30 p-3'>
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <input
          type='text' placeholder='Search' className='bg-gray-50 border border-gray-200 rounded text-sm w-full py-2 px-4 max-w-[210px]' />
      ...
      {isOpen && (
        <Modal isOpen={isOpen}
          ...
          <AiOutlineClose className='text-2xl text-gray-400 cursor-pointer absolute top-2 right-2 hover:text-red-600' onClick={() => setIsOpen(false)} />
        </Modal>
      )}
    </div>
  )
